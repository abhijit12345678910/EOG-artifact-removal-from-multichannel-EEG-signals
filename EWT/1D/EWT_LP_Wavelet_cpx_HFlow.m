function ymw=EWT_LP_Wavelet_cpx_HFlow(wn,aw,gamma,N)

%=========================================================
% function ymw=EWT_LP_Wavelet_cpx_HFlow(wn,aw,gamma,N)
%
% Generate the 1D Littlewood-Paley wavelet in the Fourier
% domain associated to scale segment [wn,pi]with transition ratio gamma.
...
%
% Output:
%   -ymw: Fourier transform of the wavelet on the band [wn,pi]
%
